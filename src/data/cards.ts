export const LOTTERY_CARDS = [
  { id: 1, name: 'El Gallo', emoji: '🐓' },
  { id: 2, name: 'El Diablito', emoji: '😈' },
  { id: 3, name: 'La Dama', emoji: '👸' },
  { id: 4, name: 'El Señor - "Don Ferruco en la alameda"', emoji: '🧔' },
  ...
  { id: 23, name: 'La Luna - "La que sale de noche"', emoji: '🌕' },
  { id: 24, name: 'El Cotorro', emoji: '🦜' },
  { id: 25, name: 'La Cerveza - "La que se sube a la cabeza"', emoji: '🍺' },
  ...
  { id: 42, name: 'El Fantasma - "Al pasar por el panteón"', emoji: '👻' },
  ...
  { id: 51, name: 'La Palmera - "Palmera, palma real"', emoji: '🌴' },
  { id: 52, name: 'La Maceta', emoji: '🪴' },
  { id: 53, name: 'El Arpa', emoji: '🎵' },
  { id: 54, name: 'La Rana', emoji: '🐸' },
  { id: 55, name: 'El Jalapeño Token - "¡El picante que da dinero!"', emoji: '🌶️' },
];
