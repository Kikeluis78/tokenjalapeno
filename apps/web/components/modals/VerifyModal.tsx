...
export const VerifyModal = ({ onVerify }: VerifyModalProps) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center bg-gradient-to-br from-black/90 via-purple-900/30 to-black/90 px-4 pb-16 backdrop-blur-sm">
      <div className="relative w-full max-w-md overflow-hidden rounded-3xl bg-gradient-to-br from-white via-blue-50 to-purple-50 p-8 pb-8 shadow-2xl animate-[slideUp_0.4s_ease-out]">
        {/* Efectos de fondo */}
