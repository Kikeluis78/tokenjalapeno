...
export default function Page() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-gradient-to-br from-[#1a0b2e] via-[#2d1b3d] to-[#1a0b2e]">
      ...
      {/* 📦 Contenido */}
      <div className="relative mx-auto flex min-h-screen w-full max-w-[480px] flex-col justify-center gap-4 px-4 py-6">
        ...
        <section className="space-y-3">
          ...
          <button
            ...
            className="w-full rounded-xl bg-gradient-to-br from-yellow-500 to-red-500 p-4 text-left font-bold text-white shadow-lg transition hover:scale-[1.02] disabled:opacity-50"
          >
          ...
          {!canPlayFree && (
            <button
              ...
              className="w-full rounded-xl bg-gradient-to-br from-cyan-500 to-purple-500 p-4 text-left font-bold text-white shadow-lg transition hover:scale-[1.02]"
            >
          ...
          <button
            type="button"
            disabled
            className="relative w-full overflow-hidden rounded-xl border-2 border-purple-500/30 bg-gradient-to-br from-purple-600/30 via-pink-600/30 to-red-600/30 p-4 text-left opacity-60"
          >
          ...
          <button
            type="button"
            disabled
            className="relative w-full overflow-hidden rounded-xl border-2 border-green-500/30 bg-gradient-to-br from-green-600/30 via-emerald-600/30 to-teal-600/30 p-4 text-left opacity-60"
          >
