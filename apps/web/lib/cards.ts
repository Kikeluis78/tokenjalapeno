...
export const LOTTERY_CARDS: Card[] = [
  ...
  { id: 12, name: "El Superheroe", emoji: "🦸" },
  ...
  { id: 44, name: "El Jarrafon", emoji: "🏺" },
  { id: 45, name: "El Venado", emoji: "🦌" },
  { id: 46, name: "El Sol", emoji: "☀️" },
  { id: 47, name: "La Corona", emoji: "👑" },
  { id: 48, name: "El Velero", emoji: "⛵" },
  { id: 49, name: "El Pino", emoji: "🌲" },
  { id: 50, name: "El Pescado", emoji: "🐟" },
  { id: 51, name: "La Palmalmera", emoji: "🌴" },
  { id: 52, name: "La Planta", emoji: "🪴" },
  { id: 53, name: "La Nota", emoji: "🎵" },
  { id: 54, name: "La Rana", emoji: "🐸" },
  { id: 55, name: "El Jalapeño", emoji: "🌶️" } // ⭐ CARTA ESPECIAL
];
